            ...
            <div className="w-[100%] md:w-[30%]">
              <ul className="space-y-4 my-5">
                <li className="cursor-pointer">
                  <Link to={'about'} duration={500} smooth={true} offset={-100}>About</Link>
                </li>
                <li>

                <Link to={'projects'} duration={500} smooth={true} offset={-100} className="cursor-pointer"><p>Projects</p></Link>
                </li>
                <li>


                <Link to={'contact'} duration={500} smooth={true} offset={-100} className="cursor-pointer"><p>Contact</p></Link>
                </li>
              </ul>
            </div>
            <div className="w-[100%] md:w-[30%]">
              <ul className="social-media text-center flex justify-center md:justify-start items-center space-x-4 mt-7 sm:mt-0">
                ...
                <li className="py-5 sm:py-0 h-[50px]">
                  <a href="https://wa.me/919322585046" target="_blank" rel="noreferrer"><i className="fa-brands fa-whatsapp text-xl px-2 py-1 text-green-600 hover:text-green-500"></i></a></li><li className="py-5 sm:py-0 h-[50px] ">
                  <a href="https://www.instagram.com/harshdesai889/" rel="noreferrer" target="_blank"><i className="fa-brands fa-instagram text-xl px-2 py-1 text-red-600 hover:text-red-300"></i></a></li>
